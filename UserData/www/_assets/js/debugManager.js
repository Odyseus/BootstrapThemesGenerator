...
var BSTG_LoggingLevel = {
    NORMAL: 0,
    VERBOSE: 1,
    VERY_VERBOSE: 2
};

var BSTG_Debugger = null;

(function() {
    class BSTG_DebuggerClass {
        constructor(aDebuggerEnabled = false, aLoggingLevel = null) {
            this._loggingLevel = aLoggingLevel || BSTG_LoggingLevel.NORMAL;
        ...
        wrapObjectMethods(aProtos, aExtraOptions = {}) {
            try {
                if (this._loggingLevel === BSTG_LoggingLevel.VERY_VERBOSE || this._debuggerEnabled) {
                    for (let name in aProtos) {
                        let options = {
                            objectName: name,
                            verbose: this._loggingLevel === BSTG_LoggingLevel.VERY_VERBOSE,
    ...
    BSTG_Debugger = new BSTG_DebuggerClass(true, BSTG_LoggingLevel.NORMAL);
    // BSTG_Debugger = new BSTG_DebuggerClass(true, BSTG_LoggingLevel.VERY_VERBOSE);
})();

/* exported BSTG_DebuggerClass,
            BSTG_LoggingLevel,
            BSTG_Debugger
 */
