...
this.buffer+=r(e)}openNode(e){if(!s(e))return;let n=e.kind
...
const E="[a-zA-Z]\\w*",x="[a-zA-Z_]\\w*",y="\\b\\d+(\\.\\d+)?",v="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",w="\\b(0b[01]+)",N={
begin:"\\\\[\\s\\S]",relevance:0},M={scope:"string",begin:"'",end:"'",
illegal:"\\n",contains:[N]},A={scope:"string",begin:'"',end:'"',illegal:"\\n",
contains:[N]},k=(e,n,t={})=>{const a=i({scope:"comment",begin:e,end:n,
contains:[]},t);a.contains.push({scope:"doctag",
begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",
end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0})
;const r=_("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/)
;return a.contains.push({begin:b(/[ ]+/,"(",r,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),a
},S=k("//","$"),C=k("/\\*","\\*/"),O=k("#","$");var T=Object.freeze({
...
},COMMENT:k,C_LINE_COMMENT_MODE:S,C_BLOCK_COMMENT_MODE:C,HASH_COMMENT_MODE:O,
...
;e.begin=e.match,delete e.match}}function P(e,n){
...
return n?Number(n):(e=>z.includes(e.toLowerCase()))(e)?0:1}const F={},H=e=>{
console.error(e)},G=(e,...n)=>{console.log("WARN: "+e,...n)},q=(e,n)=>{
F[`${e}/${n}`]||(console.log(`Deprecated as of ${e}. ${n}`),F[`${e}/${n}`]=!0)
},K=Error();function Z(e,n,{key:t}){let a=0;const r=e[t],i={},s={}
;for(let e=1;e<=n.length;e++)s[e+a]=r[e],i[e+a]=!0,a+=p(n[e-1])
;e[t]=s,e[t]._emit=i,e[t]._multi=!0}function V(e){(e=>{
...
K;Z(e,e.begin,{key:"beginScope"}),e.begin=h(e.begin,{joinWith:""})}})(e),(e=>{
...
K;Z(e,e.end,{key:"endScope"}),e.end=h(e.end,{joinWith:""})}})(e)}function W(e){
function n(n,t){
...
;[I,L,V,$].forEach((e=>e(r,s))),e.compilerExtensions.forEach((e=>e(r,s))),
r.__beforeBegin=null,[R,B,P].forEach((e=>e(r,s))),r.isCompiled=!0;let l=null
...
const J=r,Y=i,ee=Symbol("nomatch");var ne=(e=>{
const n=Object.create(null),r=Object.create(null),i=[];let s=!0
...
const l=Object.create(null);function c(){if(!M.keywords)return void k.addText(S)
;let e=0;M.keywordPatternRe.lastIndex=0;let n=M.keywordPatternRe.exec(S),t=""
;for(;n;){t+=S.substring(e,n.index)
;const r=y.case_insensitive?n[0].toLowerCase():n[0],i=(a=r,M.keywords[a]);if(i){
const[e,a]=i
;if(k.addText(t),t="",l[r]=(l[r]||0)+1,l[r]<=7&&(C+=a),e.startsWith("_"))t+=n[0];else{
const t=y.classNameAliases[e]||e;k.addKeyword(n[0],t)}}else t+=n[0]
;e=M.keywordPatternRe.lastIndex,n=M.keywordPatternRe.exec(S)}var a
;t+=S.substr(e),k.addText(t)}function g(){null!=M.subLanguage?(()=>{
if(""===S)return;let e=null;if("string"==typeof M.subLanguage){
if(!n[M.subLanguage])return void k.addText(S)
;e=h(M.subLanguage,S,!0,A[M.subLanguage]),A[M.subLanguage]=e._top
}else e=E(S,M.subLanguage.length?M.subLanguage:null)
;M.relevance>0&&(C+=e.relevance),k.addSublanguage(e._emitter,e.language)
})():c(),S=""}function u(e,n){let t=1;for(;void 0!==n[t];){if(!e._emit[t]){t++
;continue}const a=y.classNameAliases[e[t]]||e[t],r=n[t]
;a?k.addKeyword(r,a):(S=r,c(),S=""),t++}}function m(e,n){
return e.scope&&"string"==typeof e.scope&&k.openNode(y.classNameAliases[e.scope]||e.scope),
e.beginScope&&(e.beginScope._wrap?(k.addKeyword(S,y.classNameAliases[e.beginScope._wrap]||e.beginScope._wrap),
S=""):e.beginScope._multi&&(u(e.beginScope,n),S="")),M=Object.create(e,{parent:{
value:M}}),M}function b(e,n,t){let r=((e,n)=>{const t=e&&e.exec(n)
;return t&&0===t.index})(e.endRe,t);if(r){if(e["on:end"]){const t=new a(e)
;e["on:end"](n,t),t.isMatchIgnored&&(r=!1)}if(r){
for(;e.endsParent&&e.parent;)e=e.parent;return e}}
if(e.endsWithParent)return b(e.parent,n,t)}function _(e){
return 0===M.matcher.regexIndex?(S+=e[0],1):(D=!0,0)}function p(e){
const n=e[0],a=t.substr(e.index),r=b(M,e,a);if(!r)return ee;const i=M
;M.endScope&&M.endScope._wrap?(g(),
k.addKeyword(n,M.endScope._wrap)):M.endScope&&M.endScope._multi?(g(),
u(M.endScope,e)):i.skip?S+=n:(i.returnEnd||i.excludeEnd||(S+=n),
g(),i.excludeEnd&&(S=n));do{
M.scope&&k.closeNode(),M.skip||M.subLanguage||(C+=M.relevance),M=M.parent
}while(M!==r.parent);return r.starts&&m(r.starts,e),i.returnEnd?0:n.length}
let f={};function x(n,i){const o=i&&i[0];if(S+=n,null==o)return g(),0
...
const n=e[0],t=e.rule,r=new a(t),i=[t.__beforeBegin,t["on:begin"]]
;for(const t of i)if(t&&(t(e,r),r.isMatchIgnored))return _(n)
;return t.skip?S+=n:(t.excludeBegin&&(S+=n),
g(),t.returnBegin||t.excludeBegin||(S=n)),m(t,e),t.returnBegin?0:n.length})(i)
;if("illegal"===i.type&&!r){
...
;return S+=o,o.length}const y=w(e)
;if(!y)throw H(o.replace("{}",e)),Error('Unknown language: "'+e+'"')
;const v=W(y);let N="",M=i||v;const A={},k=new d.__emitter(d);(()=>{const e=[]
;for(let n=M;n!==y;n=n.parent)n.scope&&e.unshift(n.scope)
;e.forEach((e=>k.openNode(e)))})();let S="",C=0,O=0,T=0,D=!1;try{
for(M.matcher.considerAll();;){
T++,D?D=!1:M.matcher.considerAll(),M.matcher.lastIndex=O
;const e=M.matcher.exec(t);if(!e)break;const n=x(t.substring(O,e.index),e)
;O=e.index+n}return x(t.substr(O)),k.closeAllNodes(),k.finalize(),N=k.toHTML(),{
language:e,value:N,relevance:C,illegal:!1,_emitter:k,_top:M}}catch(n){
if(n.message&&n.message.includes("Illegal"))return{language:e,value:J(t),
illegal:!0,relevance:0,_illegalBy:{message:n.message,index:O,
context:t.slice(O-100,O+100),mode:n.mode,resultSoFar:N},_emitter:k};if(s)return{
language:e,value:J(t),illegal:!1,relevance:0,errorRaised:n,_emitter:k,_top:M}
;throw n}}function E(e,t){t=t||d.languages||Object.keys(n);const a=(e=>{
const n={value:J(e),illegal:!1,relevance:0,_top:l,_emitter:new d.__emitter(d)}
;return n._emitter.addText(e),n})(e),r=t.filter(w).filter(M).map((n=>h(n,e,!1)))
;r.unshift(a);const i=r.sort(((e,n)=>{
if(e.relevance!==n.relevance)return n.relevance-e.relevance
;if(e.language&&n.language){if(w(e.language).supersetOf===n.language)return 1
;if(w(n.language).supersetOf===e.language)return-1}return 0})),[s,o]=i,c=s
;return c.secondBest=o,c}function x(e){let n=null;const t=(e=>{
...
return n.split(/\s+/).find((e=>p(e)||w(e)))})(e);if(p(t))return
...
}),A("after:highlightElement",{el:e,result:i,text:a})}let y=!1;function v(){
"loading"!==document.readyState?document.querySelectorAll(d.cssSelector).forEach(x):y=!0
}function w(e){return e=(e||"").toLowerCase(),n[e]||n[r[e]]}
function N(e,{languageName:n}){"string"==typeof e&&(e=[e]),e.forEach((e=>{
r[e.toLowerCase()]=n}))}function M(e){const n=w(e)
...
q("10.7.0","Please use highlightElement now."),x(e)),configure:e=>{d=Y(d,e)},
initHighlighting:()=>{
...
},registerLanguage:(t,a)=>{let r=null;try{r=a(e)}catch(e){
if(H("Language definition for '{}' could not be registered.".replace("{}",t)),
!s)throw e;H(e),r=l}
r.name||(r.name=t),n[t]=r,r.rawDefinition=a.bind(null,e),r.aliases&&N(r.aliases,{
languageName:t})},unregisterLanguage:e=>{delete n[e]
;for(const n of Object.keys(r))r[n]===e&&delete r[n]},
listLanguages:()=>Object.keys(n),getLanguage:w,registerAliases:N,
...
},e.versionString="11.3.1",e.regex={concat:b,lookahead:g,either:_,optional:m,
...
relevance:10,contains:[r,o,s,i,{begin:/\[/,end:/\]/,contains:[{className:"meta",
begin:/<![a-z]/,end:/>/,contains:[r,i,o,s]}]}]},e.COMMENT(/<!--/,/-->/,{
...
strings:s,keywords:g}}},grmr_cmake:e=>({name:"CMake",aliases:["cmake.in"],
...
},e.HASH_COMMENT_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE]}),grmr_cpp:e=>{
...
},m=[u,l,i,t,e.C_BLOCK_COMMENT_MODE,o,s],b={variants:[{begin:/=/,end:/;/},{
begin:/\(/,end:/\)/},{beginKeywords:"new throw return else",end:/;/}],
...
className:"selector-tag",begin:"\\b("+ae.join("|")+")\\b"}]}},grmr_markdown:e=>{
...
begin:/_(?!_)/,end:/_/,relevance:0}]};a.contains.push(r),r.contains.push(a)
;let i=[n,t]
;return a.contains=a.contains.concat(i),r.contains=r.contains.concat(i),
i=i.concat(a,r),{name:"Markdown",aliases:["md","mkdown","mkd"],contains:[{
className:"section",variants:[{begin:"^#{1,6}",end:"$",contains:i},{
begin:"(?=^.+?\\n[=-]{2,}$)",contains:[{begin:"^[=-]*$"},{begin:"^",end:"\\n",
contains:i}]}]},n,{className:"bullet",begin:"^[ \t]*([*+-]|(\\d+\\.))(?=\\s+)",
end:"\\s+",excludeEnd:!0},a,r,{className:"quote",begin:"^>\\s+",contains:i,
...
end:/$/}]}},grmr_d:e=>{const n={$pattern:e.UNDERSCORE_IDENT_RE,
...
},t="((0|[1-9][\\d_]*)|0[bB][01_]+|0[xX]([\\da-fA-F][\\da-fA-F_]*|_[\\da-fA-F][\\da-fA-F_]*))",a="\\\\(['\"\\?\\\\abfnrtv]|u[\\dA-Fa-f]{4}|[0-7]{1,3}|x[\\dA-Fa-f]{2}|U[\\dA-Fa-f]{8})|&[a-zA-Z\\d]{2,};",r={
className:"number",begin:"\\b"+t+"(L|u|U|Lu|LU|uL|UL)?",relevance:0},i={
className:"number",
begin:"\\b(((0[xX](([\\da-fA-F][\\da-fA-F_]*|_[\\da-fA-F][\\da-fA-F_]*)\\.([\\da-fA-F][\\da-fA-F_]*|_[\\da-fA-F][\\da-fA-F_]*)|\\.?([\\da-fA-F][\\da-fA-F_]*|_[\\da-fA-F][\\da-fA-F_]*))[pP][+-]?(0|[1-9][\\d_]*|\\d[\\d_]*|[\\d_]+?\\d))|((0|[1-9][\\d_]*|\\d[\\d_]*|[\\d_]+?\\d)(\\.\\d*|([eE][+-]?(0|[1-9][\\d_]*|\\d[\\d_]*|[\\d_]+?\\d)))|\\d+\\.(0|[1-9][\\d_]*|\\d[\\d_]*|[\\d_]+?\\d)|\\.(0|[1-9][\\d_]*)([eE][+-]?(0|[1-9][\\d_]*|\\d[\\d_]*|[\\d_]+?\\d))?))([fF]|L|i|[fF]i|Li)?|"+t+"(i|[fF]i|Li))",
relevance:0},s={className:"string",begin:"'("+a+"|.)",end:"'",illegal:"."},o={
className:"string",begin:'"',contains:[{begin:a,relevance:0}],end:'"[cwd]?'
},l=e.COMMENT("\\/\\+","\\+\\/",{contains:["self"],relevance:10});return{
name:"D",keywords:n,contains:[e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE,l,{
className:"string",begin:'x"[\\da-fA-F\\s\\n\\r]*"[cwd]?',relevance:10},o,{
className:"string",begin:'[rq]"',end:'"[cwd]?',relevance:5},{className:"string",
begin:"`",end:"`[cwd]?"},{className:"string",begin:'q"\\{',end:'\\}"'},i,r,s,{
className:"meta",begin:"^#!",end:"$",relevance:5},{className:"meta",
begin:"#(line)",end:"$",relevance:5},{className:"keyword",
begin:"@[a-zA-Z_][a-zA-Z_\\d]*"}]}},grmr_glsl:e=>({name:"GLSL",keywords:{
...
className:"meta",begin:"#",end:"$"}]}),grmr_ini:e=>{const n=e.regex,t={
...
},o={begin:/\[/,end:/\]/,contains:[a,i,r,s,t,"self"],relevance:0
},l=n.either(/[A-Za-z0-9_-]+/,/"(\\"|[^"])*"/,/'[^']*'/);return{
name:"TOML, also INI",aliases:["toml"],case_insensitive:!0,illegal:/\S/,
contains:[a,{className:"section",begin:/\[+/,end:/\]+/},{
begin:n.concat(l,"(\\s*\\.\\s*",l,")*",n.lookahead(/\s*=\s*[^#\s]/)),
className:"attr",starts:{end:/$/,contains:[a,o,i,r,s,t]}}]}},
grmr_javascript:e=>{const n=e.regex,t=le,a={begin:/<[A-Za-z0-9\\._:-]+/,
end:/\/[A-Za-z0-9\\._:-]+>|\/>/,isTrulyOpeningTag:(e,n)=>{
const t=e[0].length+e.index,a=e.input[t]
;if("<"===a||","===a)return void n.ignoreMatch();let r
;">"===a&&(((e,{after:n})=>{const t="</"+e[0].slice(1)
;return-1!==e.input.indexOf(t,n)})(e,{after:t
})||n.ignoreMatch()),(r=e.input.substr(t).match(/^\s+extends\s+/))&&0===r.index&&n.ignoreMatch()
}},r={$pattern:le,keyword:ce,literal:de,built_in:_e,"variable.language":be
...
contains:["self"].concat(b)}]),p={className:"params",begin:/\(/,end:/\)/,
...
className:"title.class",keywords:{_:[...ge,...ue]}},E={variants:[{
match:[/function/,/\s+/,t,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],
className:{1:"keyword",3:"title.function"},label:"func.def",contains:[p],
illegal:/%/},x={
match:n.concat(/\b/,(y=[...me,"super"],n.concat("(?!",y.join("|"),")")),t,n.lookahead(/\(/)),
...
match:[/const|var|let/,/\s+/,t,/\s*/,/=\s*/,n.lookahead(N)],className:{
1:"keyword",3:"title.function"},contains:[p]};return{name:"Javascript",
aliases:["js","jsx","mjs","cjs"],keywords:r,exports:{PARAMS_CONTAINS:_,
...
contains:[p]},x,{relevance:0,match:/\b[A-Z][A-Z_0-9]+\b/,
className:"variable.constant"},f,w,{match:/\$[(.]/}]}},grmr_json:e=>({
...
end:/$/,keywords:{$pattern:/[\.\w]+/,keyword:".PHONY"}},i]}},grmr_ocaml:e=>({
...
relevance:0},{begin:/->/}]}),grmr_php:e=>{const n={className:"variable",
begin:"\\$+[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*(?![A-Za-z0-9])(?![$])"},t={
className:"meta",variants:[{begin:/<\?php/,relevance:10},{begin:/<\?[=]?/},{
begin:/\?>/}]},a={className:"subst",variants:[{begin:/\$\w+/},{begin:/\{\$/,
end:/\}/}]},r=e.inherit(e.APOS_STRING_MODE,{illegal:null
...
contains:[e.BACKSLASH_ESCAPE,t],variants:[e.inherit(r,{begin:"b'",end:"'"
}),e.inherit(i,{begin:'b"',end:'"'}),i,r,s]},l={className:"number",variants:[{
...
disableAutodetect:!0}),grmr_properties:e=>{
...
begin:"\\\\\\n"}]}}},{className:"attr",begin:t+n+"$"}]}},grmr_python:e=>{
...
contains:[e.BACKSLASH_ESCAPE,r,s,i]},{begin:/([fF][rR]|[rR][fF]|[fF])"""/,
end:/"""/,contains:[e.BACKSLASH_ESCAPE,r,s,i]},{begin:/([uU]|[rR])'/,end:/'/,
...
contains:["self",r,d,o,e.HASH_COMMENT_MODE]}]};return i.contains=[o,d,r],{
name:"Python",aliases:["py","gyp","ipython"],unicodeRegex:!0,keywords:a,
illegal:/(<\/|->|\?)|=>/,contains:[r,d,{begin:/\bself\b/},{beginKeywords:"if",
...
begin:/^>>>(?=[ ]|$)/},{begin:/^\.\.\.(?=[ ]|$)/}]}]}),grmr_scss:e=>{
const n=te(e),t=se,a=ie,r="@[a-z-]+",i={className:"variable",
...
}].concat(i,s),relevance:0}].concat(i,s);o.contains=u,g.contains=u;const m=[{
...
aliases:["yml"],contains:l}}});const fe=ne;for(const e of Object.keys(pe)){
const n=e.replace("grmr_","").replace("_","-");fe.registerLanguage(n,pe[e])}
return fe}()
